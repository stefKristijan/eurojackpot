...
public class StatisticsServiceImpl implements StatisticsService {
    ...
    @Override
    public List<NumberCoefficient> nextDrawNumberCoefficients(int lotteryId, Integer draws, Integer maxDraws, Double rangeMultiplier, Double mcMultiplier, Double drawnMultiplier, Integer range) {
        Lottery lottery = lotteryRepository.findById(lotteryId)
            .orElseThrow(() -> new EntityNotFoundException(Constants.NOT_FOUND_LOTTERY));
