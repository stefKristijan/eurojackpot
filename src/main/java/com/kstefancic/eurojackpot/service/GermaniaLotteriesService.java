...
import static com.kstefancic.eurojackpot.domain.Constants.GERMANIA_LINK;
import static com.kstefancic.eurojackpot.domain.Constants.GRCKI_KINO;
import static com.kstefancic.eurojackpot.domain.Constants.GRCKI_KINO_UK;
import static com.kstefancic.eurojackpot.domain.Constants.GREEK_KINO_GERMANIA_NAME;
import static com.kstefancic.eurojackpot.domain.Constants.ITALIAN_KENO_GERMANIA_NAME;
import static com.kstefancic.eurojackpot.domain.Constants.TALIJANSKI_KENO;
import static com.kstefancic.eurojackpot.domain.Constants.TALIJANSKI_KENO_UK;
...
public class GermaniaLotteriesService {
    ...
    public void updateDraws() {
        try {
            ...
            logger.info("Added {} {} draws and {} {} draws", italianKeno.getDraws().size() - italianSize, TALIJANSKI_KENO,
                greekKino.getDraws().size() - greekSize, GRCKI_KINO);
        } catch (Exception e) {
